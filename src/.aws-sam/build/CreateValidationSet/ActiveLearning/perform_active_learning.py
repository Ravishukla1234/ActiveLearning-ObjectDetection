...
def collect_inference_outputs(inference_output_uri):
    ...
    """
    sagemaker_output_file = "newlabelled.manifest"
    ...
    print("prediction_output_s3",prediction_output_s3)
...
def lambda_handler(event, context):
    ...
    job_name_prefix = meta_data['human_label_config']['labeling_job_name']
